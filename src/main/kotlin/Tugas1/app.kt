 ...
 */
fun myProfile() {
    val namaDepan: String = "Ananda Bagus"
    val namaBelakang: String = "Lanang Samudra"
    val umur: Int = 22
    val status: Boolean = false

    println("Nama anda : $namaDepan $namaBelakang")
...
fun groupDetail(groupId: Int, groupMember: List<Any>, session: String): Any {
    ...
    println("Dari grup : $groupId")
    println("Terdiri dari : $groupMember")
 ...
 */
fun myGroup(): String {
    val namaKelompok: String = "WasWas"
...
fun main() {
     ...
     *
     */
    groupDetail(3, listOf("Hafara Putri Fardyan Awalza", "I gusti Ngurah Adi Permana", "Mikais Rizki Triwan", "Ananda Bagus Lanang Samudra"), "Afternoon")
}